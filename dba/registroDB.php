<?php
	...
	if( mysqli_connect_error()){
		...
		if ($_POST['registro']){
				...
				$corr_elect=$_POST['corr_elect'];
				
				//$corr_elect=mysqli_real_escape_string($link, $corr_elect);

				$qry_ins_fields = "INSERT INTO `idc_identidad`(`curp`,`ap_paterno`,`ap_materno`,`nombre`,`f_nac`,`nac_ciudad`,`nac_estado`, `dom_calle_num`,`dom_col`,`dom_cod_post`,`dom_ciudad`,`dom_estado`,`num_cta_agua`,`num_cta_luz`, `tel_res`,`tel_cel`, `corr_elect`)";

				$qry_ins_values = "VALUES ('".$curp."', '".$ap_paterno."', '".$ap_materno."', '".$nombre."','".$f_nac."', '".$nac_ciudad."', '".$nac_estado."', '".$dom_calle_num."', '".$dom_col."', '".$dom_cod_post."', '".$dom_ciudad."','".$dom_estado."', '".$num_cta_agua."', '".$num_cta_luz."', '".$tel_res."', '".$tel_cel."', '".$corr_elect."')";
